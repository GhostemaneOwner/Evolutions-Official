//this gets their real screen resolution using javascript. Created by Tenkichi 2023
...
client
	var/resolutionX = 1920 //just some default values for no real reason
	var/resolutionY = 1080
	var/resolutionInitialized = 0
